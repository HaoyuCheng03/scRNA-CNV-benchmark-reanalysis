...
- **`get_cont_gt_aneufinder.R`** – Constructs sample-level continuous pseudobulk CNV ground truth by aggregating AneuFinder copy number estimates using either sample-specific ploidy or the default diploid threshold.
